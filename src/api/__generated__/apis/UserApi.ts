...
import { User, UserFromJSON, UserMapFromJSON, UserToJSON } from '../models';
...
export class UserApi extends runtime.BaseAPI {
     ...
     * Create user
     */
    async createUserRaw(requestParameters: { body: User }): Promise<runtime.ApiResponse<void>> {
     ...
     * Create user
     */
    async createUser(requestParameters: { body: User }): Promise<void> {
     ...
     */
    async createUsersWithArrayInputRaw(requestParameters: { body: Array<User> }): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError(
                'body',
     ...
     * Creates list of users with given input array
     */
    async createUsersWithArrayInput(requestParameters: { body: Array<User> }): Promise<void> {
     ...
     * Creates list of users with given input array
     */
    async createUsersWithListInputRaw(requestParameters: { body: Array<User> }): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError(
                'body',
     ...
     * Creates list of users with given input array
     */
    async createUsersWithListInput(requestParameters: { body: Array<User> }): Promise<void> {
     ...
     * Delete user
     */
    async deleteUserRaw(requestParameters: { username: string }): Promise<runtime.ApiResponse<void>> {
     ...
     * Delete user
     */
    async deleteUser(requestParameters: { username: string }): Promise<void> {
     ...
     */
    async getUserByNameRaw(requestParameters: { username: string }): Promise<runtime.ApiResponse<User>> {
        if (requestParameters.username === null || requestParameters.username === undefined) {
            throw new runtime.RequiredError(
                'username',
     ...
     * Get user by user name
     */
    async getUserByName(requestParameters: { username: string }): Promise<User> {
     ...
     */
    async loginUserRaw(requestParameters: {
        username: string;
        password: string;
     ...
     * Logs user into the system
     */
    async loginUser(requestParameters: { username: string; password: string }): Promise<string> {
     ...
     * Updated user
     */
    async updateUserRaw(requestParameters: { username: string; body: User }): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.username === null || requestParameters.username === undefined) {
            throw new runtime.RequiredError(
                'username',
     ...
     * Updated user
     */
    async updateUser(requestParameters: { username: string; body: User }): Promise<void> {
