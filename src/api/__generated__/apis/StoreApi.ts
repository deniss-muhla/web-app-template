...
import { Order, OrderFromJSON, OrderMapFromJSON, OrderToJSON } from '../models';
...
export class StoreApi extends runtime.BaseAPI {
     ...
     */
    async deleteOrderRaw(requestParameters: { orderId: number }): Promise<runtime.ApiResponse<void>> {
     ...
     */
    async getOrderByIdRaw(requestParameters: { orderId: number }): Promise<runtime.ApiResponse<Order>> {
        if (requestParameters.orderId === null || requestParameters.orderId === undefined) {
            throw new runtime.RequiredError(
                'orderId',
     ...
     */
    async placeOrderRaw(requestParameters: { body: Order }): Promise<runtime.ApiResponse<Order>> {
     ...
     * Place an order for a pet
     */
    async placeOrder(requestParameters: { body: Order }): Promise<Order> {
